...
import top.yhl.cloud.log.entity.CustomeTimeModulee;
...
public class JsonTool {
    ...
    private static class JacksonObjectMapper extends ObjectMapper {
        ...
        public JacksonObjectMapper() {
            ...
            //序列化时，日期的统一格式
            super.setDateFormat(new SimpleDateFormat(DateTool.PATTERN_DATETIME, Locale.CHINA));
            // 单引号
            ...
            //日期格式化
            super.registerModule(new CustomeTimeModulee());
            super.findAndRegisterModules();
        }
