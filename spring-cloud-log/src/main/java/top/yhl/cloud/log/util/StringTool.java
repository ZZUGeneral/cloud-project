...
import top.yhl.cloud.log.constants.CharPool;
 ...
 * @date 2020/09/04
 */
public class StringTool extends org.springframework.util.StringUtils {
     ...
     * <pre class="code">
     * StringTool.isBlank(null) = true
     * StringTool.isBlank("") = true
     * StringTool.isBlank(" ") = true
     * StringTool.isBlank("12345") = false
     * StringTool.isBlank(" 12345 ") = false
     * </pre>
     *
    ...
    public static boolean isBlank(final CharSequence cs) {
        return !StringTool.hasText(cs);
    }

    /**
     * <p>Checks if a CharSequence is not empty (""), not null and not whitespace only.</p>
     * <pre>
     * StringTool.isNotBlank(null)	  = false
     * StringTool.isNotBlank("")		= false
     * StringTool.isNotBlank(" ")	   = false
     * StringTool.isNotBlank("bob")	 = true
     * StringTool.isNotBlank("  bob  ") = true
     * </pre>
     *
    ...
    public static boolean isAnyBlank(final CharSequence... css) {
        ...
        return Stream.of(css).anyMatch(StringTool::isBlank);
    }
    ...
    public static boolean isNoneBlank(final CharSequence... css) {
        ...
        return Stream.of(css).allMatch(StringTool::isNotBlank);
    }
    ...
    public static boolean isAllBlank(final CharSequence... css) {
        return Stream.of(css).allMatch(StringTool::isBlank);
    }
    ...
    public static String format(@Nullable String message, @Nullable Map<String, Object> params) {
        ...
        for (int start, end; (start = message.indexOf(StringPool.DOLLAR_LEFT_BRACE, cursor)) != -1 && (end = message.indexOf(StringPool.RIGHT_BRACE, start)) != -1; ) {
            ...
            Object value = params.get(StringTool.trimWhitespace(key));
    ...
    public static String join(Collection<?> coll) {
        return StringTool.collectionToCommaDelimitedString(coll);
    }
    ...
    public static String join(Collection<?> coll, String delim) {
        return StringTool.collectionToDelimitedString(coll, delim);
    }
    ...
    public static String join(Object[] arr) {
        return StringTool.arrayToCommaDelimitedString(arr);
    }
    ...
    public static String join(Object[] arr, String delim) {
        return StringTool.arrayToDelimitedString(arr, delim);
    }
    ...
    public static String escapeHtml(String html) {
        return StringTool.isBlank(html) ? StringPool.EMPTY : HtmlUtils.htmlEscape(html);
    }
    ...
    public static String[] splitTrim(@Nullable String str, @Nullable String delimiter) {
        return StringTool.delimitedListToStringArray(str, delimiter, " \t\n\n\f");
    }
     ...
     *
     * <pre>
     * StringTool.subBefore(null, *)      = null
     * StringTool.subBefore("", *)        = ""
     * StringTool.subBefore("abc", "a")   = ""
     * StringTool.subBefore("abcba", "b") = "a"
     * StringTool.subBefore("abc", "c")   = "ab"
     * StringTool.subBefore("abc", "d")   = "abc"
     * StringTool.subBefore("abc", "")    = ""
     * StringTool.subBefore("abc", null)  = "abc"
     * </pre>
     *
     ...
     *
     * <pre>
     * StringTool.subAfter(null, *)      = null
     * StringTool.subAfter("", *)        = ""
     * StringTool.subAfter(*, null)      = ""
     * StringTool.subAfter("abc", "a")   = "bc"
     * StringTool.subAfter("abcba", "b") = "cba"
     * StringTool.subAfter("abc", "c")   = ""
     * StringTool.subAfter("abc", "d")   = ""
     * StringTool.subAfter("abc", "")    = "abc"
     * </pre>
     *
     * @param string          被查找的字符串
     * @param separator       分隔字符串（不包括）
     ...
     *
     * <pre>
     * StringTool.subBetween("wx[b]yz", "[", "]") = "b"
     * StringTool.subBetween(null, *, *)          = null
     * StringTool.subBetween(*, null, *)          = null
     * StringTool.subBetween(*, *, null)          = null
     * StringTool.subBetween("", "", "")          = ""
     * StringTool.subBetween("", "", "]")         = null
     * StringTool.subBetween("", "[", "]")        = null
     * StringTool.subBetween("yabcz", "", "")     = ""
     * StringTool.subBetween("yabcz", "y", "z")   = "abc"
     * StringTool.subBetween("yabczyabcz", "y", "z")   = "abc"
     * </pre>
     *
     * @param str    被切割的字符串
     ...
     * StringTool.subBetween(null, *)            = null
     * StringTool.subBetween("", "")             = ""
     * StringTool.subBetween("", "tag")          = null
     * StringTool.subBetween("tagabctag", null)  = null
     * StringTool.subBetween("tagabctag", "")    = ""
     * StringTool.subBetween("tagabctag", "tag") = "abc"
     * </pre>
     *
     * @param str            被切割的字符串
     ...
     *
     * <pre>
     * StringTool.ordinalIndexOf(null, *, *)          = -1
     * StringTool.ordinalIndexOf(*, null, *)          = -1
     * StringTool.ordinalIndexOf("", "", *)           = 0
     * StringTool.ordinalIndexOf("aabaabaa", "a", 1)  = 0
     * StringTool.ordinalIndexOf("aabaabaa", "a", 2)  = 1
     * StringTool.ordinalIndexOf("aabaabaa", "b", 1)  = 2
     * StringTool.ordinalIndexOf("aabaabaa", "b", 2)  = 5
     * StringTool.ordinalIndexOf("aabaabaa", "ab", 1) = 1
     * StringTool.ordinalIndexOf("aabaabaa", "ab", 2) = 4
     * StringTool.ordinalIndexOf("aabaabaa", "", 1)   = 0
     * StringTool.ordinalIndexOf("aabaabaa", "", 2)   = 0
     * </pre>
     *
